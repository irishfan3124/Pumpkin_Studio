...
- Stem square peg with a 0.6 mm tapered lead-in, 6 mm insertion length, 0.15 mm socket clearance per side, and 0.3 mm bottom clearance. The socket has a reinforced boss and closed floor. Test fit and sand as needed; printer calibration determines how snug the fit will be.
